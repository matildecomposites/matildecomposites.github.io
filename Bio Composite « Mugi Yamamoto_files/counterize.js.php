		...
		if( document.domain )
		{
			...
			else
			{
				el.onclick = function()
				{
					...
					var url = '/wp-content/plugins/counterize/counterize.php?external=1&href=' + escape( this.href ) + '&from=' + escape( window.location.href ) + '&time=1376965506';
					request.abort();
...
/*
     FILE ARCHIVED ON 02:25:06 Aug 20, 2013 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 159.963
  exclusion.robots: 0.082
  exclusion.robots.policy: 0.075
  RedisCDXSource: 1.895
  esindex: 0.007
  LoadShardBlock: 140.874 (3)
  PetaboxLoader3.datanode: 92.949 (4)
  CDXLines.iter: 15.135 (3)
  load_resource: 97.262
  PetaboxLoader3.resolve: 38.419
*/